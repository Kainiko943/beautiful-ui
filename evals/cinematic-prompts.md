...
- WebGL/Three.js/canvas/media hero plan
...
```text
Use beautiful-ui and cinematic-web-experience to recreate the style of a viral cinematic website demo. Do not copy protected branding or assets. Preserve the mood: dark luxury tech, sparse nav, glowing focal object, particles, bloom, glass panels, scroll-driven reveal, and demo-worthy first viewport.
```
